...
import 'package:best_flutter_ui_templates/fitness_app/chatbot_doctor/chatbot_doctorList.dart';
...
class MyDiaryScreen extends StatefulWidget {
  const MyDiaryScreen({Key? key, this.callBack, this.animationController})
      : super(key: key);
...
class _MyDiaryScreenState extends State<MyDiaryScreen>
  ...
  void addAllListData() {
    ...
    listViews.add(
      TitleView(
        titleTxt: 'What can we help you today?',
        subTxt: '',
